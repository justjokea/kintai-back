...
import com.tss.mybatisplus.annotation.DbType;
import com.tss.mybatisplus.annotation.IdType;
import com.tss.mybatisplus.generator.AutoGenerator;
import com.tss.mybatisplus.generator.config.DataSourceConfig;
import com.tss.mybatisplus.generator.config.GlobalConfig;
import com.tss.mybatisplus.generator.config.PackageConfig;
import com.tss.mybatisplus.generator.config.StrategyConfig;
import com.tss.mybatisplus.generator.config.rules.NamingStrategy;
...
public class CodeGenerator {
    ...
    public void genCode() {
        ...
        //设置数据库的访问地址
        dsc.setUrl("jdbc:mysql://localhost:3306/db_tss?serverTimezone=GMT%2B8&characterEncoding=utf-8");
        //设置数据库驱动配置
        ...
        //文件的包存储路径
        pc.setParent("com.tss.mybatis.plus");
